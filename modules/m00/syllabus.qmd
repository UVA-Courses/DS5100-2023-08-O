...
::: {.callout-note}
If an issue will prompt late submission, please submit a formal request to [this form](request_form_url). 
Requests are not guaranteed to be granted; the default timeframe for completion is generous.
:::
...
::: {.callout-important}
Please submit these as soon after the class meeting as possible. They are meant to provide evidence of your participation in class; submitting them late defeatst that purpose.
:::
...
::: {.callout-warning}
Making up missed quizzes is not advised &mdash; their timing is part of their value. However, if you know in advance that you will miss any of the scheduled quizzes, you must make arrangements in advance with the instructor. At least one week in advance if possible, or as soon as you are able if an unforeseen event occurs preventing you from taking the quiz.
:::
